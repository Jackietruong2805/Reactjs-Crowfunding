...
const DashboardSidebar = () => {
    const navlinkClass = 'flex items-center text-icon-color lg:mb-8 gap-x-5 lg:w-12 lg:h-12 lg:justify-center lg:rounded-lg last:mt-auto last:bg-white last:shadow-sdprimary'
  return (
