...
const DashboardSearch = () => {
  ...
  return (
    <div className="relative z-50">
      <div className="flex items-center p-2 bg-white rounded-full shadow-[10px_10px_20px_rgba(218,213,213,0.15)]">
        ...
        <button className="flex-shrink-0 w-[72px] h-10 rounded-full bg-primary text-white flex items-center justify-center">
          <svg
      ...
      {showSearch &&<div className="search-results w-full lg:w-[843px] pb-6 rounded-3xl bg-white absolute top-full translate-y-5 left-0 z-50">
