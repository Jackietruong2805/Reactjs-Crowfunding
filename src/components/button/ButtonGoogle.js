...
const ButtonGoogle = ({ text = "Sign up with google", onClick = () => {} }) => {
  return (
    <button
      className="flex items-center justify-center w-full py-4 mb-5 text-base font-semibold border text-text2 rounded-xl border-stroke gap-x-2 dark:text-white dark:border-darkStroke"
      onClick={onClick}
    >
